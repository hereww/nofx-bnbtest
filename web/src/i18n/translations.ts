...
export const translations = {
  en: {
    ...
    telegram: {
      ...
      groupBound: 'Bound',
      groupNotBound: 'Not bound',
      groupStep1: '1. Add the Bot to the Telegram group',
      groupStep2: '2. Send in the group:',
      groupStep3: '3. Start a conversation:',
      groupQuestion: 'your question',
      groupOwnerOnly: 'All group members can chat in isolated read-only sessions. Only the bound administrator can access the account or operate the trading system.',
      save: 'Save',
      loading: 'Loading...',
    },
  ...
  zh: {
    ...
    telegram: {
      ...
      groupBound: '已绑定',
      groupNotBound: '未绑定',
      groupStep1: '1. 将 Bot 添加到需要使用的 Telegram 群',
      groupStep2: '2. 在群里发送：',
      groupStep3: '3. 开始对话：',
      groupQuestion: '你的问题',
      groupOwnerOnly: '所有群成员都能使用相互隔离的只读会话；只有当前绑定管理员可以访问账户和操作交易系统。',
      save: '保存',
      loading: '加载中...',
    },
  ...
  id: {
    ...
    telegram: {
      ...
      groupBound: 'Terhubung',
      groupNotBound: 'Belum terhubung',
      groupStep1: '1. Tambahkan Bot ke grup Telegram',
      groupStep2: '2. Kirim di grup:',
      groupStep3: '3. Mulai percakapan:',
      groupQuestion: 'pertanyaan Anda',
      groupOwnerOnly: 'Semua anggota grup dapat mengobrol dalam sesi hanya-baca yang terpisah. Hanya administrator terhubung yang dapat mengakses akun atau mengoperasikan sistem trading.',
      save: 'Simpan',
      loading: 'Memuat...',
    },
