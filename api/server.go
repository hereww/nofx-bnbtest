...
StrategyConfig fields:
  ...
  indicators.nofxos_api_key: legacy optional key; normally leave empty because data is read from DATA_GATEWAY_URL.
...
func (s *Server) handleGetSystemConfig(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"btc_eth_leverage": 10,
		"altcoin_leverage": 5,
		"data_gateway_url": config.Get().DataGatewayURL,
	})
}
